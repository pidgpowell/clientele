...
<template>
  ...
  <Head>
    ...
    <Link href="https://fonts.googleapis.com/css2?family=Public+Sans:wght@100;700&display=swap" rel="stylesheet" />
  </Head>

  <div class="p-4 sm:p-16 pb-4 grid gap-8 h-screen">
    <div class="flex flex-col gap-4">
      <h1 class="mb-2">
        <svg aria-labelledby="title" class="w-full h-auto fill-neutral-500" height="279" viewBox="0 0 1451 279"
          width="1451" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="grid grid-cols-3 gap-2 sm:gap-4 max-w-[30%] lg:max-w-[20%] ml-auto">
        <twitter :width="iconWidth" :colorDark="primaryDark" :colorLight="primaryLight" :colorHover="primaryHover"
          url="https://twitter.com/theclientele" />
        <instagram :width="iconWidth" :colorDark="primaryDark" :colorLight="primaryLight" :colorHover="primaryHover"
          url="https://www.instagram.com/theclienteleband/" />
        <facebook :width="iconWidth" :colorDark="primaryDark" :colorLight="primaryLight" :colorHover="primaryHover"
          url="https://www.facebook.com/theclienteleofficial" />
      </div>

      <div v-if="home" class="-mt-8 md:-mt-12 xl:-mt-[5%] ml-[3.4vw] py-2 pl-8 md:pl-[3.7vw] border-l sm:border-l-2 border-gray-100 prose md:max-w-[59vw]">
