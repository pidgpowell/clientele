      ...
      <NuxtLink to="/" class="outline-none focus-visible:ring-2">
        <h1>
          <svg
            ...
            class="w-full h-auto fill-neutral-500 dark:fill-slate-400"
            height="279"
